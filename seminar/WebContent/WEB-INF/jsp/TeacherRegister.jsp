...
<form class="form-inline" id="subject" action="" method="post" >
 	<div class="form-group">
		...
		<input name="Radio1" type="radio" class="radio" />火曜　<input name="Radio1" type="radio" class="radio" />木曜<br>

		<dl class="submit">
			<button name="submit" type="submit" value="登録" class="btn btn-default"/>
